...
def get_suggestions():
    ...
    try:
        ...
        messages = [
            ...
            {"role": "user", "content": f"Blood sugar: {blood_sugar}, Vitamin A: {vitamin_a}, Vitamin B12: {vitamin_b12}, Vitamin C: {vitamin_c}, Vitamin D: {vitamin_d}, Vitamin E: {vitamin_e}, Cholesterol: {cholesterol}, Triglycerides: {triglycerides}, Blood Pressure: {blood_pressure}, Hemoglobin: {hemoglobin}"}
        ]
